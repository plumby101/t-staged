var productModule = function() {
    ...
    $(document).ready(function() {
        ...
        setSwatchText();
         if($('.product-accordion').length){if($('span.desc-prod-code').text().match(/FJGKC/)){$('.product-details #ctab-1').hide();$('div.add-to-bag').hide();$('div.add-wishlist-item-wrapper').hide();}};
        checkToDisableAddToBag();
        getProductStockInfo();
